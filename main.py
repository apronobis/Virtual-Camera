...
class VirtualCameraApp(QMainWindow):
    ...
    def update_camera_feed(self):
        ...
        frame = background_change(self.background_image, frame, self.blur_switch.switch.isChecked(), self.green_screen_switch.switch.isChecked(), input_sessiion=self.session)
