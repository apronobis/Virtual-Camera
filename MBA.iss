...
Filename: "{cmd}"; Parameters: "/C {userpf}\MBA\Dependency\AkVirtualCamera\{code:GetArch}\AkVCamManager add-device -i ""AkVCamVideoDevice0"" ""Virtual Camera"""; Flags: runhidden runascurrentuser; StatusMsg: "Adding Virtual Camera..."
